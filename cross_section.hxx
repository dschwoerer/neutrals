...
public:
  virtual Field3D cx_rate(const Field3D &T_e) override { return mycx; }
  virtual Field3D ionisation_rate(const Field3D &T_e) override { return myion; }
...
public:
  static CrossSection *create(Options *opt) {
    ...
    if (type == "radiation") {
      ...
      throw BoutException(
          "Unknown CrossSection requested for CrossSectionFactory::create - '%s'",
          type.c_str());
    }
  }
};
